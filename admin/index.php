                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">     
                            <br><br> 
                                <center><h1><b>Selamat Datang,  <?php echo $_SESSION['nama'];?></b></h1></center>
                                 <center><h1><b>di Sistem Informasi Manajemen Berkas Administrasi</b></h1></center>
                            <br><br>  
                        </div>
                      </div>
                                <?php include '../koneksi/koneksi.php';
                                $sql1		= "SELECT * FROM tb_berkas1";  
                      ...
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <a href="databerkas.php"><h3>Berkas 1</h3></a>
                      ...
                      <!-- <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <a href="dataperban.php"><h3>Berkas 2</h3></a>
                          <p>Telah Diarsipkan</p>
                        </div>
                      </div>
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <a href="datase.php"><h3>Berkas 3</h3></a>
                          <p>Telah diarsipkan</p>
                        </div>
                      </div> -->
                    </div>
